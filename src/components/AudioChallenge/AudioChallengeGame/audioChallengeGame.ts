...
class AudioChallengeGame implements IAudioChallengeGame {
  ...
  turnAudioOn(target: HTMLElement) {
    ...
    const element = document.getElementById('wordSound') as HTMLMediaElement;
    element.play();
  }
      ...
      main.innerHTML = `
        <section class="${classPrefix}-game">
          <div class="${classPrefix}-game__card">
            <div>
              <svg class="button" id="turnAudioOn" xmlns="http://www.w3.org/2000/svg" height="48" width="48">
